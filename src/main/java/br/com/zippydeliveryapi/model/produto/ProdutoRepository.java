...
//    @Query(value = "SELECT p FROM Produto p WHERE p.titulo like %:titulo% AND p.categoria.id = :idCategoria AND p.codigo = :codigo")
//    List<Produto> consultarPorTituloECategoriaECodigo(String titulo, Long idCategoria, String codigo);
